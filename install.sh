...
project_name="hello-world" # Name of project
project_url="https://github.com/mattzipin/hello-world/releases/download/1.0.1/matts-program.tar.gz" # URL of project tarball
